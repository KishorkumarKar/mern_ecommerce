                    ...
                    <nav className="primary-nav primary-nav-wrapper--border">
                        <div className="container">
                            ...
                            <div className="primary-nav">
                                {/* <!--====== Main Logo ======--> */}
                                <Link className="main-logo" to={this.url.home}>
                                    <img src={process.env.PUBLIC_URL + "assets/images/logo/logo-1.png"} alt="" />
                                </Link>
                                {/* <!--====== End - Main Logo ======--> */}
                                {/* <!--====== Search Form ======--> */}
                                            ...
                                            <li className="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Account">
                                                ...
                                                <ul style={{ width: "120px" }}>
                                                    ...
                                                    <li>
                                                        ...
                                                        <Link className="main-logo" to={this.url.signup}>
                                                            <i className="fas fa-user-plus u-s-m-r-6"></i>
                                                            <span>Signup</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link to={this.url.login}>
                                                            <i className="fas fa-lock u-s-m-r-6"></i>
                                                            <span>Signin</span>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link className="main-logo" to="/" onClick={this.logout}>
                                                                ...
                                                                <div className="col-lg-9 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-0.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* <!--====== End - Mega Menu Row ======--> */}
                                                        ...
                                                        <div className="mega-menu-content">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-1.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-2.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* <!--====== End - Mega Menu Row ======--> */}
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-9 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-3.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-3 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-4.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* <!--====== End - Mega Menu Row ======--> */}
                                                        ...
                                                        <div className="mega-menu-content">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-4 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-5.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-4 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-6.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-4 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-7.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* <!--====== End - Mega Menu Row ======--> */}
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-8.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 mega-image">
                                                                    <div className="mega-banner">
                                                                        <a className="u-d-block" href="shop-side-version-2.html">
                                                                            <img className="u-img-fluid u-d-block" src={process.env.PUBLIC_URL + "assets/images/banners/banner-mega-9.jpg"} alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* <!--====== End - Mega Menu Row ======--> */}
                                                    ...
                                                    <div className="mini-product-container gl-scroll u-s-m-b-15">
                                                            ...
                                                            <div className="mini-product">
                                                                <div className="mini-product__image-wrapper">
                                                                    <a className="mini-product__link" href="product-detail.html">
                                                                        <img className="u-img-fluid" src={process.env.PUBLIC_URL + "assets/images/product/electronic/product3.jpg"} alt="" /></a>
                                                                </div>
                                                        ...
                                                        <div className="card-mini-product">
                                                            <div className="mini-product">
                                                                <div className="mini-product__image-wrapper">
                                                                    <a className="mini-product__link" href="product-detail.html">
                                                                        <img className="u-img-fluid" src={process.env.PUBLIC_URL + "assets/images/product/electronic/product18.jpg"} alt="" /></a>
                                                                </div>
                                                                <div className="mini-product__info-wrapper">
                                                                    <span className="mini-product__category">
                                                                        <a href="shop-side-version-2.html">Electronics</a></span>
                                                        ...
                                                        <div className="card-mini-product">
                                                            <div className="mini-product">
                                                                <div className="mini-product__image-wrapper">
                                                                    <a className="mini-product__link" href="product-detail.html">
                                                                        <img className="u-img-fluid" src={process.env.PUBLIC_URL + "assets/images/product/women/product8.jpg"} alt="" /></a>
                                                                </div>
                                                                <div className="mini-product__info-wrapper">
                                                                    <span className="mini-product__category">
                                                        ...
                                                        <div className="card-mini-product">
                                                            <div className="mini-product">
                                                                <div className="mini-product__image-wrapper">
                                                                    <a className="mini-product__link" href="product-detail.html">
                                                                        <img className="u-img-fluid" src={process.env.PUBLIC_URL + "assets/images/product/men/product8.jpg"} alt="" /></a>
                                                                </div>
                                                                <div className="mini-product__info-wrapper">
                                                                    <span className="mini-product__category">
